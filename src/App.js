...
const NFTCONTRACT = "0x763442BB79dC2AB17c3ce95670169fef92B6c055";
const STAKINGCONTRACT = "0xC767e793177385Ce7A2d1bbaE5523A6FD7a34B29";
...
const moralisapikey = "";
const nftpng =
  "https://ipfs.io/ipfs/QmU3cBSLNhAFLHH6QMPXWTgKaLEPrimQk9PP1tJB11P3ns/";
...
const providerOptions = {
  ...
  walletconnect: {
    ...
    options: {
      infuraId: "0263478979584a738ac6d1e806487ace",
    },
  },
  coinbasewallet: {
    package: CoinbaseWalletSDK,
    options: {
      appName: "Lumino NFT Minter",
      infuraId: "0263478979584a738ac6d1e806487ace",
      rpc: "",
      chainId: 4,
      appLogoUrl: null,
                  ...
                  <div className="row mt-2">
                    <div className="col xs={10} md={8}">
                      ...
                      <button
                        ...
                        onClick={mint0}
                      >
                        <img src="lmnr-logo.png" width="90" height="90" />
                      </button>
                      <button
                        style={{
                          marginRight: "2px",
                      ...
                      <button
                        ...
                        onClick={mint}
                      >
                        <img src="ethereum.png" width="90" height="90" />
                      </button>
                    </div>
                  </div>
                  <div class="root">
                    <div class="header">
                      ...
                      >
                        LMNR NFT Staking Pools Active Rewards
                      </div>
                    </div>
                    <table
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="exchange">
                            ...
                            <span class="currency">100 LMNR/M</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    >
                      ...
                      <tbody>
                        <tr>
                          <td>Stake LMNR to Earn LMNR</td>
                          <td class="amount" data-test-id="rewards-summary-ads">
                            <span class="amount">0.01</span>&nbsp;
                            <span class="currency">Per LMNR</span>
                          </td>
                        </tr>
                        <tr>
                          <td>Stake LMNR to Earn LMNR+</td>
        ...
        <div className="container">
          <div className="row">
            ...
            >
              ...
              <Button onClick={rewardinfo}>Earned LMN Rewards</Button>
              <div
                id="earned"
                style={{
                  color: "#39FF14",
